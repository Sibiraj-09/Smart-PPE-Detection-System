...
from detection import PPEDetector, draw_detection_results
from rfid import RFIDReader
from db import PPEDatabase
...
OUTPUT_FOLDER = os.path.join(os.path.dirname(os.path.dirname(__file__)), "backend", "output")
DB_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "ppe.db")
